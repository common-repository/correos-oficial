...
/**
 * Class Obtain_Merged_On_A4_Format_Handler
 */
class Obtain_Merged_On_A4_Format_Handler {
	...
	/**
	 * Obtain_Merged_On_A4_Format_Handler constructor.
	 *
	 ...
	 * Execute service
	 *
	 * @param Obtain_Merged_On_A4_Format_Request $request Obtain_Merged_On_A4_Format_Request.
	 *
	...
	public function __invoke( $request ) {
		...
		$merged_download_link = $this->merge_labels->a4_format( $merged_order_ids, $position );

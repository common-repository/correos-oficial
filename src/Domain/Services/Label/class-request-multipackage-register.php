...
use WooEnvio\WECorreos\Domain\Model\Correos\Preregistro\Preregistro_Multibulto_Data;
...
/**
 * Class Request_Multipackage_Register
 */
class Request_Multipackage_Register {

	/**
	 * Preregistro_Multibulto
	 *
	 * @var Preregistro_Multibulto
	 */
	private $client_correos;
	/**
	 * Preregistro_Multibulto_Data_Factory
	 *
	 * @var Preregistro_Multibulto_Data_Factory
	 */
	private $register_data_factory;

	/**
	 * Request_Multipackage_Register constructor.
	 *
	 * @param Preregistro_Multibulto              $client_correos Preregistro_Multibulto.
	 * @param Preregistro_Multibulto_Data_Factory $register_data_factory Preregistro_Multibulto_Data_Factory.
	 */
	...
	public function __invoke( $general, $sender, $label, $order ) {
		...
		//var_dump('DEBUG REQUEST_REGISTER_LABEL_C', $register_data->data());
